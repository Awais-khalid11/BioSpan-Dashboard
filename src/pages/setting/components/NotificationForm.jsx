    ...
    <div>
      <form>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-4 md:gap-2">
            {[
              ...
              <div
                key={key}
                className={`flex items-center justify-between px-4 py-3 rounded-[12px] border w-full md:w-[32%] ${
                  notifications[key] ? "border-green-500" : "border-[#ccc]"
                }`}
              >
                <span className="text-sm text-[#252525]">{label}</span>
        ...
        <div className="flex flex-wrap gap-2.5">
          ...
          <button
            type="submit"
            className="w-full md:w-[79%] bg-[#072723] text-white px-6 py-[17px] rounded-[12px] border text-sm font-extrabold"
          >
            Save Changes
          </button>
        </div>
