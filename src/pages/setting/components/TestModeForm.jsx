      ...
      <div>
        ...
        <div className="flex items-center gap-4">
          <button
            type="button"
            onClick={handleReset}
            className="flex items-center gap-2 px-6 py-3 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
          >
            <svg
              className="w-4 h-4"
              fill="none"
          ...
          <button
            ...
            className="flex items-center text-center justify-center gap-2 px-6 py-3 bg-[#072723] text-white font-medium rounded-lg hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-colors flex-1"
          >
            <svg
              className="w-4 h-4"
              fill="none"
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-[#B0ED56] text-black font-medium rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
          >
            Run Test
            <CiPlay1 />
          </button>
